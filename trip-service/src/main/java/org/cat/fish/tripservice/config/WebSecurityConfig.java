...
import org.cat.fish.tripservice.security.jwt.JwtEntryPoint;
import org.cat.fish.tripservice.security.jwt.JwtTokenFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/trip/booking/**").authenticated()
