package org.cat.fish.userservice.config.kafka;
...
public class CommonConfiguration {
    @Autowired
    private ReactiveKafkaAppProperties kafkaAppProperties;

    @Bean
    KafkaSender<String, String> kafkaSender(ReactiveKafkaAppProperties reactiveKafkaAppProperties) {
    ...
    @Bean
    ReceiverOptions<String, String> receiverOptions(ReactiveKafkaAppProperties reactiveKafkaAppProperties) {
